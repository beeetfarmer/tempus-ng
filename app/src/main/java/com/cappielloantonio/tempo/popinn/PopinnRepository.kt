...
class PopinnRepository {
     ...
     */
    fun getArtistVideos(artistName: String?, limit: Int): LiveData<PopinnArtistVideos> {
        val result = MutableLiveData<PopinnArtistVideos>()

        if (artistName.isNullOrBlank() || !PopinnClient.isConfigured()) {
            result.value = PopinnArtistVideos.empty()
            return result
        }
        ...
        when {
            cachedId == NO_MATCH -> result.value = PopinnArtistVideos.empty()
    ...
    fun getArtistVideoPage(artistId: String, skip: Int, limit: Int): LiveData<PopinnArtistVideos> {
        val result = MutableLiveData<PopinnArtistVideos>()
    ...
    private fun resolveThenFetch(
        ...
        artistName: String,
        limit: Int,
        result: MutableLiveData<PopinnArtistVideos>
    ) {
            ...
            .enqueue(object : Callback<List<PopinnArtist>> {
                override fun onResponse(
                    ...
                    if (matchedId == null) {
                        ...
                        result.postValue(PopinnArtistVideos.empty())
                        return
                    }
    ...
    private fun fetchVideos(
        ...
        api.getVideos(
            ...
            override fun onResponse(call: Call<PopinnVideoPage>, response: Response<PopinnVideoPage>) {
                ...
                result.postValue(PopinnArtistVideos(artistId, page.items, page.total, page.skip))
            }
...
data class PopinnArtistVideos(
    ...
    companion object {
        fun empty() = PopinnArtistVideos(null, emptyList(), 0, 0)
    }
}
